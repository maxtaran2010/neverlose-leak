#pragma once
/*
    nl_darkside — darkside SDK + NeverLose algorithm reconstructions
    Infrastructure: shialex, lostedd, opai, neverfair team (darkside-sdk-fix-main)
    NL algorithms: reversed from neverlose_final.dll (ImageBase 0x1a9363a0000)
*/

// vcxproj adds darkside-sdk-fix-main\darkside_sdk to AdditionalIncludeDirectories,
// so all sub-includes below resolve to the SDK's files automatically.
